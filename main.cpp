...
// Minden lehetseges nyeresi eredmenyek
...
//Összes lehetséges elérhető mozgás
...
char get_oppenent_marker(char marker)
{
...
//Ha valaki gyozott vagy veszitett
int get_board_state(char board[3][3], char marker)
{
    char opponent_marker = get_oppenent_marker(marker);
    ...
    for (int i = 0; i < legal_moves.size(); ++i)
    {
     ...
     //Maximalizaljuk a jatekost
        if (marker == AI_MARKER)
        {
            ...
            //legjobb/rosszabb lepes vizsgalata
...
int main()
{
    ...
    cout << "**************\n\n\tTic Tac Toe AI\n\n****************" << endl << endl;
    cout << "Player = X\t AI Computer = 0" << endl << endl;
